...
public class TrackerHandler : MonoBehaviour
{
    ...
    public Transform bodyParent;// will use to get children for all body joints
    public Transform[] bodyJoints;// will contain all joints
    ...
    void Awake()
    {
        ...
        bodyJoints = new Transform[bodyParent.childCount];

        for (int i = 0; i < bodyParent.childCount; i++)
        {
            bodyJoints[i] = bodyParent.GetChild(i).transform;
        }
    }
