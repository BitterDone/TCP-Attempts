...
public class TrackingTcpClient : MonoBehaviour
{
    ...
    public void Start()
    {
        connectButton.onClick.AddListener(() => Connect(IP, port));
    }
    ...
    public void ExchangePackets()
    {
        while (!exchangeStopRequested)
        {
            ...
            writer.Write("X\n");
            UnityEngine.Debug.Log("Sent data!");
            ...
            lastPacket = received;
            UnityEngine.Debug.Log("Read data: " + received);
    ...
    private void ReportDataToTrackingManager(string data)
    {
        if (data == null)
        {
            UnityEngine.Debug.Log("Received a frame but data was null");
            return;
        }
        else
        {
